...
class ConfigurationTest < Minitest::Test
  ...
  def test_required_primary_key_when_primary_key_configured
    ...
    assert_raises Enumerations::Error::MissingPrimaryKey, 'Enumeration primary key is required' do
  ...
  def test_duplicated_primary_key_when_primary_key_configured
    ...
    assert_raises Enumerations::Error::DuplicatedPrimaryKey, 'Duplicate primary key 1' do
